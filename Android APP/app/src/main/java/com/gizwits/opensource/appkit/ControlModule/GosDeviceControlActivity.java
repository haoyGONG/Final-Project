...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private Switch sw_bool_Forward;
	...
	private void initView() {
		...
		sw_bool_Forward = (Switch) findViewById(R.id.sw_bool_Forward);
	}

	private void initEvent() {

		sw_bool_Forward.setOnClickListener(this);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.sw_bool_Forward:
			sendCommand(KEY_FORWARD, sw_bool_Forward.isChecked());
			break;
		default:
			break;
		}
	...
	protected void updateUI() {
		...
		sw_bool_Forward.setChecked(data_Forward);
